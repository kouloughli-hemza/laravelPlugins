...
namespace Kouloughli\Plugins\Console\Commands;
...
class RemovePluginCommand extends PluginCommand
{
     ...
     * @var string
     */
    protected $name = 'Kouloughli:remove-plugin';
    ...
    public function handle()
    {
        ...
        if ($this->pluginIsStillActive()) {
            ...
            $message .= " plugins inside the KouloughliServiceProvider first.";
            $this->error($message);
            return;
        }
    ...
    private function pluginIsStillActive()
    {
        ...
        return isset(Kouloughli::availablePlugins()[$pluginClassName]);
    }
